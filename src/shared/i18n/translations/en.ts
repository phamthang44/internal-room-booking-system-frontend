...
export const en = {
  ...
  penalties: {
    page: {
      ...
      subtitle: "Review your current restrictions, history, and recorded violations.",
    },
    tabs: {
      active: "Active",
      history: "History",
    ...
    labels: {
      points: "points",
      booking: "Booking",
      noReason: "No additional details provided.",
      starts: "Starts: {{start}}",
      ends: "Ends: {{end}}",
    },
    violationTypes: {
    ...
    states: {
      loading: "Loading penalty data...",
      loadFailed: "Failed to load penalty data. Please try again.",
    },
    empty: {
      active: "You have no active penalties.",
      history: "No penalty history available.",
      violations: "No violations recorded.",
    },
    banner: {
      viewDetails: "View details",
      permanentBanTitle: "Account permanently banned",
      temporaryBanTitle: "Account temporarily banned",
      approvalRequiredTitle: "Bookings require admin approval",
      warningTitle: "Warning",
      bannedUntil: "You can’t create new bookings until {{end}}.",
      approvalRequiredUntil: "Bookings will require approval until {{end}}.",
      permanentBanHint: "You can’t create new bookings until this is revoked by an admin.",
      warningHint: "Please avoid further violations to prevent suspension.",
    },
  },
  adminPenalties: {
    ...
    page: {
      ...
      tabs: { penalties: "Penalties", violations: "Violations" },
      sections: { penalties: "Penalty records", violations: "Violations" },
    },
    active: "Active penalty",
    noneActive: "No active penalty",
    activeType: "Type: {{type}}",
    activeUntil: "Until {{end}}",
    actions: {
      extend: "Extend",
      revoke: "Revoke",
      viewAll: "View all",
    ...
    revoke: {
      ...
      reasonPlaceholder: "Why are you revoking this penalty?",
      confirm: "Revoke",
    },
    extend: {
      title: "Extend penalty",
      reasonPlaceholder: "Why are you extending this penalty?",
      confirm: "Extend",
      dateHint: "End date will be sent as ISO-8601 (UTC) to the backend.",
    },
  },
  dashboard: {
  ...
  adminUsers: {
    ...
    penaltiesHint: {
      title: "How to view a user's penalties",
      body: "Open a user in the details drawer, then scroll to “Penalty management” and click “View all” to see that user’s penalties and violations.",
    },
